/*
***********************************************
Proyecto: AgruparBotones
Autor: Edgar Antonio Salas González
Ultima edición: 25 de febrero del 2018
...
public class AgruparBotones extends JFrame
    ...
    public AgruparBotones(String titulo) {
        ...
        //Se crea un contenedor Animalitos donde se agrega el radioPanel y la imagen
        JPanel Animalitos = new JPanel();
        Animalitos.setLayout(new BoxLayout(Animalitos,BoxLayout.X_AXIS));
        Animalitos.add(radioPanel);
        Animalitos.add(picture);
        ...
        //Se crea un contenedor para poner los dos botones 
        ...
        //Se agragan al panel principal y se posicionan en su lugar
        JPanel Principal = new JPanel();
        Principal.setLayout(new BorderLayout());
        getContentPane().add(Animalitos, BorderLayout.NORTH);
